**CodeBook for Course Project in "Getting and Cleaning Data" at Coursera**
...
Note: the files in Inertial Signals were not used

**Transformations made to create final "Tidy" Datasets**
